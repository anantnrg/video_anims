...
export default makeScene2D(function* (view) {
    ...
    <Rect layout ref={codeblock_rect} direction={"column"} scale={0}>
      ...
      >
        <Icon
          ...
          marginRight={15}
        />
        <Txt fontFamily={"JetBrains Mono"} fontSize={22} fill="#cdd6f4">
          main.rs
        </Txt>
      </Rect>
      <Rect
  ...
  yield view.add(
    <Rect
      ...
      opacity={0}
    >
      <CodeBlock fontFamily={"JetBrains Mono"} fontSize={36} code={error} />,
    </Rect>,
  );
  ...
  yield view.add(
    ...
    >
      ...
      <Rect layout ref={output_rect} opacity={0} marginTop={30} marginRight={0}>
        <Txt
          ref={output_rect_txt}
          fill="#cdd6f4"
          antialiased={true}
  ...
  yield view.add(
    ...
    >
      <Circle
        ...
        stroke={"#45475a"}
      />
      <Rect alignItems={"center"} layout direction={"column"}>
        <Icon
  ...
  yield view.add(
    ...
    >
      <Line
        ...
        stroke="#cdd6f4"
        startArrow
        points={[Vector2.zero, Vector2.right.scale(150)]}
        arrowSize={22}
        marginRight={40}
        marginLeft={40}
      />
  ...
  yield* chain(
    ...
    codeblock().edit(0.55)`let ${insert(
      "mut ",
    )}x = 0;\nx = 1;\nprintln!(\"{}\", x);`,
  );
  yield* codeblock().selection(lines(0, Infinity));
  ...
  yield* chain(
    ...
    codeblock().edit(0.55)`let mut x${remove(
      " = 0",
    )};\nx = 1;\nprintln!(\"{}\", x);`,
  );
  yield* codeblock().selection(lines(0, Infinity));
  ...
  yield* chain(
    ...
    waitFor(0.25),
    codeblock().edit(0.55)`let mut x${insert(
      " = 0",
    )};\nx = 1;\nprintln!(\"{}\", x);`,
